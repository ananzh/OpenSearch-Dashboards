...
const totalAggregations = [
  ...
  {
    value: AggTypes.MIN,
    text: i18n.translate('visTypeTableNew.totalAggregations.minText', {
      defaultMessage: 'Min',
    }),
  },
  {
    value: AggTypes.MAX,
    text: i18n.translate('visTypeTableNew.totalAggregations.maxText', {
      defaultMessage: 'Max',
    }),
  },
  {
    value: AggTypes.COUNT,
    text: i18n.translate('visTypeTableNew.totalAggregations.countText', {
