    ...
    <EuiPanel paddingSize="s">
      <NumberInputOption
        label={
          <>
            <FormattedMessage
              id="visTypeTableNew.params.perPageLabel"
      ...
      <SwitchOption
        label={i18n.translate('visTypeTableNew.params.showMetricsLabel', {
      ...
      <SwitchOption
        label={i18n.translate('visTypeTableNew.params.showPartialRowsLabel', {
          defaultMessage: 'Show partial rows',
        })}
        tooltip={i18n.translate('visTypeTableNew.params.showPartialRowsTip', {
          defaultMessage:
      ...
      <SwitchOption
        label={i18n.translate('visTypeTableNew.params.showTotalLabel', {
      ...
      <SelectOption
        label={i18n.translate('visTypeTableNew.params.totalFunctionLabel', {
      ...
      <SelectOption
        label={i18n.translate('visTypeTableNew.params.PercentageColLabel', {
