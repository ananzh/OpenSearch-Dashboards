    ...
    try {
      ...
      if (savedExploreObject.id) {
        ...
        const savedExplore: SavedExplore = {
          ...
          title,
          description,
          searchSource: {} as any, // Will be populated from searchSourceFields
      ...
      const errorMessage = `Failed to load saved explore: ${loadError.message}`;
      setError(errorMessage);

      toastNotifications.addError(loadError, {
