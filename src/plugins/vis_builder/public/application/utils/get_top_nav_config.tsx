...
export const getOnSave = (
  ...
  const onSave = async ({
    ...
    const query = data.query.queryString.getQuery() || null;
    const filter = data.query.filterManager.getFilters() || null;
    searchSourceInstance.filter = filter;
    searchSourceInstance.query = query;
