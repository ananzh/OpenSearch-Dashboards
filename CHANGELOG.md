...
- [Table Visualization] Move format table logic to table render and solidate types ([#3397](https://github.com/opensearch-project/OpenSearch-Dashboards/pull/3397))
